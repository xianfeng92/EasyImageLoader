package com.xforg.easyimage.utils;
...
import com.xforg.easyimage.config.GlobalConfig;
...
import static com.xforg.easyimage.config.Contants.ANDROID_RESOURCE;
import static com.xforg.easyimage.config.Contants.FOREWARD_SLASH;
...
public class ImageUtil {
    ...
    public static ImageConfig.BitmapListener getBitmapListenerProxy(final ImageConfig.BitmapListener listener) {
        return (ImageConfig.BitmapListener) Proxy.newProxyInstance(ImageConfig.class.getClassLoader(),
    ...
    public static boolean shouldSetPlaceHolder(ImageConfig config) {
    ...
    public static Uri buildUriByType(ImageConfig config) {
        ...
        Log.d("builduri:", "url: " + config.getUrl() + " ---filepath:" + config.getFilePath() + "--content:" + config.getContentProvider());
